...
let outdoors = L.tileLayer('https://api.mapbox.com/styles/v1/outdoors/outdoors-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
	attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery (c) <a href="https://www.mapbox.com/">Mapbox</a>',
	maxZoom: 18,
	accessToken: API_KEY
});
...
// Add a 3rd layer group variable for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicplates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();

// Add a reference to the tectonic plates group to the overlays object.
// Add a reference to the major earthquake data tot he overlays object. 
let overlays = {
